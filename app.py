...
st.write(
    ...
    "theo luật thuế mới nhất năm 2026"
)
...
if st.button(
    ...
    st.subheader(
        "📜 Giải Trình Chi Tiết Quy Trình Khấu Trừ"
    )
...
"""
    ...
    if res["tax"] > 0:
        ...
        st.success(
            "Tuyệt vời! Thu nhập tính thuế bằng 0 nên không phát sinh thuế TNCN."
        )
```
